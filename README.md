...
| Zoned Year ([`Zoned`](https://datetime-polyglot.mmauro.dev/datetime-polyglot/dev.mmauro.datetimepolyglot/-zoned)<[`Int`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/)>) | Yes                 | 🧪 [`RelativeZonedYearLocalizer`](https://datetime-polyglot.mmauro.dev/datetime-polyglot/dev.mmauro.datetimepolyglot.localizers.relative/-relative-zoned-year-localizer) <br> _No extension function_                                                                                                      | `last yr., Los Angeles Time` <br> `this year, PT` <br> `in 5y, America/Los_Angeles`                           |
...
| Zoned Year ([`Zoned`](https://datetime-polyglot.mmauro.dev/datetime-polyglot/dev.mmauro.datetimepolyglot/-zoned)<[`Int`](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/)>) | 🧪 [`DynamicZonedYearLocalizer`](https://datetime-polyglot.mmauro.dev/datetime-polyglot/dev.mmauro.datetimepolyglot.localizers.dynamic/-dynamic-zoned-year-localizer) <br> _No extension function_                                                                                                    | `last year, Pacific Time` <br> `in 5y, PT` <br> `2026, Los Angeles Time`                                            |

#### 🧪 Custom dynamic localizer

It is possible to use
the [DynamicLocalizer](https://datetime-polyglot.mmauro.dev/datetime-polyglot/dev.mmauro.datetimepolyglot.localizers.dynamic/-dynamic-localizer)
class to create a localizer with custom thresholds.

The constructor accepts a list of threshold cases plus a fallback case if none of them match. The first case that
...
DynamicLocalizer(
    DynamicLocalizer.Case.Threshold(
        range = instantRange1 /* custom instant range */,
        localizer = localizer1,
    ),
    DynamicLocalizer.Case.Threshold(
        range = instantRange2 /* custom instant range */,
        localizer = localizer2,
    ),
    default = DynamicLocalizer.Case.Default(localizer3),
)
```