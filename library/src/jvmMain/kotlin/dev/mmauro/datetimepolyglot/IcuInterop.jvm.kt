...
internal actual fun RelativeDateTimeFormatter.formatDirection(direction: RelativeDirection, unit: RelativeUnit): String? {
    ...
    val unit = when (unit) {
        ...
        RelativeUnit.DateTimeComponent.MINUTE -> IcuRelativeDateTimeFormatter.AbsoluteUnit.MINUTE
        RelativeUnit.DateTimeComponent.HOUR -> IcuRelativeDateTimeFormatter.AbsoluteUnit.HOUR
